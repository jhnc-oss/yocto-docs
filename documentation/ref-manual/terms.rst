...
.. glossary::
   ...
   :term:`Build Directory`
      ...
      examples assume your :term:`Source Directory` is named ``workspace``:
      ...
      -  Create the :term:`Build Directory` inside your home directory and
         ...
         .. code-block:: console
            ...
            $ source workspace/layers/openembedded-core/oe-init-build-env test-builds
      ...
      -  Provide a directory path and specifically name the
         ...
         .. code-block:: shell
            ...
            $ source workspace/layers/openembedded-core/oe-init-build-env mybuilds/YP-&DISTRO;
