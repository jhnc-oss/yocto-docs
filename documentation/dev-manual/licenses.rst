...
``meta/recipes-multimedia/gstreamer/gst-plugins-ugly`` of
:term:`OpenEmbedded-Core (OE-Core)` recipe contains the following statement::
...
``meta/recipes-multimedia/gstreamer/gst-plugins-ugly`` of
:term:`OpenEmbedded-Core (OE-Core)` package, you
